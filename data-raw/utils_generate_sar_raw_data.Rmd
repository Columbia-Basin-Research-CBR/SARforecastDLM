...
sar_raw_data <- SalmonSurvCUI %>% 
  ...
  mutate(year = as.numeric(year),
        ...
        add_row(year = max(.$year)+1, logit.s = NA, sar.method = "Scheurell and Williams (2005)", value = NA, index = "CUI") %>%  #add 2006 NA row for ahead forecast
...
ggplot() +
  geom_line(data = df_marss, aes(x = year, y = sar*100), color = "red") + #, color = "Scheurell and Williams (2005)")) +
